...
function Signup() {
  ...
  await axios.post("https://book-store-app-api-zeta.vercel.app/user/signup",userInfo)
  .then((res)=> {
          ...
          <div className="modal-box">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='mt-4 space-y-2'>
                ...
                />
                <br />
                {errors.fullname && <span className='text-sm text-red-900'>{errors.name.message}</span>}
              </div>
